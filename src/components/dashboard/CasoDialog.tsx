    ...
    if (open) {
      ...
      if (caso) {
        setFormData({
          ...
          lugar_sepultacion_cremacion: caso.lugar_sepultacion_cremacion || "",
  ...
  const renderForm = () => (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <Label htmlFor="lugar_sepultacion_cremacion">Lugar de Sepultación/Cremación</Label>
            <Input
              id="lugar_sepultacion_cremacion"
              value={formData.lugar_sepultacion_cremacion}
              onChange={(e) => setFormData({ ...formData, lugar_sepultacion_cremacion: e.target.value })}
              placeholder="Cementerio o crematorio"
            />
          </div>
          <div>
